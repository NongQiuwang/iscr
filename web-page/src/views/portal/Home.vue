  ...
  <div class="portal-home">
    ...
    <nav class="navbar" :class="{ 'navbar-scrolled': isScrolled }">
      <div class="nav-container">
        ...
        <div class="nav-links">
          <a href="#cars">Featured Cars</a>
          <a href="#" @click.prevent="router.push('/about')">About Us</a>
          <div class="auth-section">
            <template v-if="!userInfo">
              <el-button class="btn-login" @click="gotoLogin">Login</el-button>
            </template>
            <template v-else>
              <el-dropdown trigger="click">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item @click="router.push('/profile')">My Reservations</el-dropdown-item>
    ...
    <section class="hero">
      ...
      <div class="hero-content fade-in-up">
        <h1 class="hero-title">Start Your <span>Extraordinary</span> Journey</h1>
        <p class="hero-subtitle">Explore top luxury vehicles and experience the ultimate driving pleasure. We offer more than just a rental: a statement of status.</p>
        <div class="hero-actions">
          <el-button class="btn-primary" @click="scrollToCars">Explore Now</el-button>
        </div>
      </div>
    </section>
    ...
    <main id="cars" class="main-content">
        ...
        <el-col :xs="24" :sm="12" :md="8" v-for="(car, index) in carList" :key="car.carId">
          <div class="car-card-wrapper fade-in-up" :style="{ animationDelay: index * 0.1 + 's' }">
            <el-card :body-style="{ padding: '0px' }" class="car-card" @click="showCarDetail(car)">
              <div class="car-image">
                <img :src="getCarImage(car.imagePath)" alt="Car image" />
      ...
      <el-empty v-if="!loading && carList.length === 0" description="No cars match your criteria" />
    </main>

    <!-- Car detail dialog: frosted-glass effect -->
    <el-dialog 
        ...
        <el-row :gutter="40">
          <el-col :md="12">
            <div class="detail-image-box">
              <img :src="getCarImage(currentCar.imagePath)" alt="Car image" />
            </div>
          </el-col>
          <el-col :md="12">
            <div class="detail-info-grid">
              ...
              <div class="info-item">
                ...
                <span class="value">{{ currentCar.seatCount }} seats</span>
              </div>
            </div>
            <div class="detail-price-section">
              ...
              >
                {{ currentCar.status === 0 ? 'Reserve Now' : 'Unavailable' }}
              </el-button>
            </div>
          </el-col>
        </el-row>
    ...
    <el-dialog v-model="reservationVisible" title="Reservation Details" width="450px" center>
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" class="btn-confirm" @click="submitReservation">Submit Reservation</el-button>
        </div>
      </template>
    </el-dialog>
...
import { getAllCars } from '@/api/modules/car'
...
const handleReservation = () => {
  if (!userInfo.value) {
    ElMessage.warning('Please log in to make a reservation')
    router.push({ path: '/login', query: { redirect: `/cars/${currentCar.value.carId}` } })
    return
  }
