<template>
  <div class="dashboard">
    <div class="welcome-header">
      <h1>Overview</h1>
      <p>Welcome back, {{ userInfo?.username }}. Here is the current system status.</p>
    </div>
      ...
      <el-col :span="16">
        <div class="admin-card">
          ...
          <el-table :data="recentReservations" style="width: 100%" size="small">
            ...
            <el-table-column prop="startDate" label="Date" width="120" />
            <el-table-column prop="status" label="Status" width="100">
              <template #default="{ row }">
                <el-tag size="small" :type="row.status === 0 ? 'warning' : 'success'">
                  {{ row.status === 0 ? 'Pending' : 'Confirmed' }}
                </el-tag>
              </template>
            </el-table-column>
          </el-table>
          ...
          <div class="notice-list">
            <div class="notice-item">
              ...
              <div class="notice-text">
                <p>The system has been upgraded to the premium visual version</p>
            ...
            <div class="notice-item">
              <span class="dot"></span>
              <div class="notice-text">
                <p>Spring Festival rental business adjustment notice</p>
...
import { getAllReservations } from '@/api/modules/reservation'
...
const statCards = ref([
  { label: 'Total Vehicles', value: 0, icon: Van, color: '#409eff', bg: '#ecf5ff' },
  { label: 'Registered Users', value: 2, icon: User, color: '#67c23a', bg: '#f0f9eb' },
  { label: 'Reservations', value: 0, icon: List, color: '#e6a23c', bg: '#fdf6ec' },
  { label: 'AvailableVehicle', value: 0, icon: CircleCheck, color: '#f56c6c', bg: '#fef0f0' }
])
